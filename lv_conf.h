...
#if LV_MEM_CUSTOM == 0
#  define LV_MEM_SIZE    (4U * 1024U)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
...
#define LV_VDB_SIZE       (10 * LV_HOR_RES) //  ((LV_VER_RES * LV_HOR_RES) / 10)
...
//#define USE_ENVY_C_14					   1
//#define USE_LV_FONT_SYMBOL_14              1
