 ...
 * DELAY INTERFACE
 *********************/
#define LV_DRV_DELAY_INCLUDE  "../misc/delay.h"            /*Dummy include by default*/
 ...
 *  Common
 *----------*/
#define LV_DRV_INDEV_INCLUDE     "drv_encoder.h"             /*Dummy include by default*/
#define LV_DRV_INDEV_RST(val)    /*pin_x_set(val) */    /*Set the reset pin to 'val'*/
#define LV_DRV_INDEV_IRQ_READ    encoder_read()      /*Read the IRQ pin*/

/*---------
 *  SPI
 *---------*/
#define LV_DRV_INDEV_SPI_CS(val)            //XPT2046_spi_cs_set(val)     /*Set the SPI's Chip select to 'val'*/
#define LV_DRV_INDEV_SPI_XCHG_BYTE(data)    //SPI_XchgByte(data)     /*Write 'val' to SPI and give the read value*/
